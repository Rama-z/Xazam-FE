...
export const login = (body) => axios.post(`https://xazam-be.vercel.app/api/xazam/auth/login`, body);
...
export const profiles = (token) => axios.get(`https://xazam-be.vercel.app/api/xazam/profile`, config(token));
